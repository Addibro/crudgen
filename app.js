...
// url/uri for inventpf record
// http://10.210.59.20:10032/web/services/FinalTest/select/{PAGE}/{COUNT}
...
app.set('view engine', 'pug'); // what engine to use to render views (Jade)
